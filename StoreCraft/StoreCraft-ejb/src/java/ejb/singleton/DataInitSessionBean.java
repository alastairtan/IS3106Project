...
public class DataInitSessionBean {
    ...
    private void initializeData() {
        ...
        try {
            ...
            productEntityControllerLocal.createNewProduct(new ProductEntity("PROD003", "ASUS VivoBook 14 X405", "Everyday: All-rounder for work and play. Windows 10. Full HD display", 100, 10, new BigDecimal("799.00"), "https://brain-images-ssl.cdn.dixons.com/0/4/10157740/u_10157740.jpg"), asusCategory.getCategoryId(), tagIdsPopularDiscount);
            ...
            productEntityControllerLocal.createNewProduct(new ProductEntity("PROD005", "Dell Inspiron 7370", "Dell Inspiron laptop features Intel Core i5-8250U offers seamless multitasking", 100, 10, new BigDecimal("2799.00"), "https://smartsystems.jo/image/cache/catalog/products/computer-systems/laptops/3567-1200x1200.jpg"), dellCategory.getCategoryId(), tagIdsPopularDiscountNew);
            productEntityControllerLocal.createNewProduct(new ProductEntity("PROD006", "Dell XPS 13", "Our smallest 13.3\" (33.8cm) laptop has a virtually borderless InfinityEdge display — available with touch.", 100, 10, new BigDecimal("2899.00"), "https://cf2.s3.souqcdn.com/item/2017/10/18/26/03/11/71/item_XL_26031171_47987159.jpg"), dellCategory.getCategoryId(), tagIdsEmpty);
